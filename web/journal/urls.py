...
urlpatterns = [
    ...
    path('market/', views.MarketDataHubView.as_view(), name='market_data'),
    path('market/equities/', views.MarketEquitiesHubView.as_view(), name='market_equities'),
    ...
    path(
        'commodity-curves/backtest/',
        views.CommodityCurveBacktestView.as_view(),
        name='commodity_curve_backtest',
    ),
    path('risk/', views.RiskHubView.as_view(), name='risk'),
    path('risk/calibration/', views.CalibrationView.as_view(), name='calibration'),
