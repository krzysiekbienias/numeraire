...
CommodityFuturesOutrightProduct::CommodityFuturesOutrightProduct(std::string contract_ticker,
...
OptionType CommodityFuturesOutrightProduct::OptionKind() const {
    return OptionType::kCall;
}

ExerciseStyle CommodityFuturesOutrightProduct::Exercise() const {
    return ExerciseStyle::kEuropean;
}

double CommodityFuturesOutrightProduct::Strike() const {
    return 0.0;
}

const schedule::Date& CommodityFuturesOutrightProduct::TradeDate() const {
    return trade_date_;
}
...
std::string_view CommodityFuturesOutrightProduct::ProductCode() const {
    return product_code_;
}

bool CommodityFuturesOutrightProduct::UsesImpliedVolatility() const {
    return false;
}

bool CommodityFuturesOutrightProduct::HasCalendarMaturity() const {
    return true;
}
