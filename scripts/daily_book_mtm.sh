...
main() {
    ...
    log "MTM EOD: quote/vol/rate from DB (run daily_market_prep first)"
    run_cmd env NUMERAIRE_DEV_QUOTE_SOURCE=db NUMERAIRE_DEV_VOL_SOURCE=db NUMERAIRE_DEV_RATE_SOURCE=db \
